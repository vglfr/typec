...
fn3:
	@nasm -felf64 asm/fn3_fadd.s -o asm/fn3_fadd.o
	@nasm -felf64 asm/fn3_exit.s -o asm/fn3_exit.o
	@nasm -felf64 asm/fn3_printf_f64.s -o asm/fn3_printf_f64.o
	@nasm -felf64 asm/fn3_main.s -o asm/fn3_main.o
